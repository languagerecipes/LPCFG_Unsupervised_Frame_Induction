 ...
 */
public class FrozenGoodEvaluateColdStartAverageForAMBG {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.err.println("Runing " + FrozenGoodEvaluateColdStartAverageForAMBG.class.getName());
        List<String> gFiles = new ArrayList<>();
        gFiles.add("../lr/starsem/golddata/ambg.txt"); //15
        int datasetIndex = 0;
    ...
    private static void process(String goldFile, List<Fragment> inputFramentList,
        ...
        /// 
        double mergeEndValueStep1 = .2;//.05;//.4//.3 for pearson;
