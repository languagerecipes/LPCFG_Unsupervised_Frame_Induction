 ...
 */
public class SplitMergeSplitMergeForFutureDev {
    ...
    private static String goldFile = "devdata-published/task-2.1.txt";
...
//        });
        ...
        List<Fragment> deleted = new ArrayList<>();
...
//                System.err.println("!>THE SYSTEM CANNOT HANDLE VERBS WITH NO ARGUMENT --> REMOVED " + s.toStringPosition("UNKNWOWN"));
        ...
        System.err.println("> Loaded records to Cluster: " + inputFramentListInput.size());
        ...
        System.err.println("> Vocab set size " + vectorSimilarities.getVocabSetSize());
        ...
        PrintWriter mmTest = new PrintWriter("output.debug.txt");
        mergeStart.forEach(p -> {
            mmTest.println(p.toStringStdEvaluation());
        });
        mmTest.close();
            ...
            for (Collection<HierachyBuilderResultWarpper> collection : splitCollectionBySize) {
                ...
                while (iterator.hasNext()) {
                    ...
                    try {
                        ...
                        Logger.getLogger(SplitMergeSplitMergeForFutureDev.class.getName()).log(Level.SEVERE, null, ex);
                    }
