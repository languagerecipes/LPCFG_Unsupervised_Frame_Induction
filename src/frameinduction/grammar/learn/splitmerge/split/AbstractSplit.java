...
public abstract class AbstractSplit {
    ...
    private static final Logger LOGGER = Logger.getLogger(AbstractSplit.class.getName());
    final protected Map<String, Map<String, Double>> ruleMapUnaryRest;
    final protected Map<String, Map<String, Double>> ruleMapUnaryToSplit;
    final protected Map<String, Map<String, Map<String, Double>>> rulMapBinaryRest;
    final protected Map<String, Map<String, Map<String, Double>>> ruleMapBinaryToSplit;
    final protected RuleMaps ruleMapToManipulate; // this can be removed , to make sure test it

    //final protected int tgtIndex;
   // final protected int roleLargestIndex;
   // final protected int newRoleIndex1;
   // final protected int newRoleIndex2;

    final protected Map<String, String> symbolMappingMemory;
     ...
     * @throws Exception
     */
    public AbstractSplit(RuleMaps rm) throws Exception {
     ...
     * @return
     */
    protected abstract boolean conditionForSplit(String symbol);
...
//        //System.err.println("\t+"+sum);
     ...
     * @param lhs
     */
    protected abstract String[] splitSymbol(String lhs);
//    throws Exception {
...
//                && SymbolFractory.isLhsForSemanticRole(lhs, this.tgtIndex)) {
//
//            String lhs1 = SymbolFractory.getUnaryLHSForNonVerbial(this.newRoleIndex1);
//            String lhs2 = SymbolFractory.getUnaryLHSForNonVerbial(this.newRoleIndex2);
...
//    }
    ...
    protected void addRulesToRuleMapBin(RuleMaps rm, Map<String, Map<String, Map<String, Double>>> rulMapBinaryRest) throws Exception {
    ...
    protected void addRulesToRuleMapUnary(RuleMaps rm, Map<String, Map<String, Double>> unaryRuleMap) throws Exception {
