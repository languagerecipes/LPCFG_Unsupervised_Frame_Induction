 ...
 */
public class SplitRoles {

    private static final Logger LOGGER = Logger.getLogger(SplitRoles.class.getName());
    ...
    final private int tgtRole;
    final private int roleLargestIndex;
    final private int newRoleIndex1;
    final private int newRoleIndex2;
     ...
     * @throws Exception
     */
    public SplitRoles(int roleIndex, RuleMaps rm) throws Exception {
        this.tgtRole = roleIndex;
        ...
        this.roleLargestIndex = this.ruleMapToManipulate.getRolesLargestIndex();

        //  System.err.println("Largest index " + roleLargestIndex);
        this.newRoleIndex1 = this.roleLargestIndex + 1;
        this.newRoleIndex2 = this.roleLargestIndex + 2;
...
//        }
    ...
    private boolean conditionForSplit(String symbol) {
        return SymbolFractory.isLhsForSemanticRole(symbol, tgtRole);
    }
...
//        return randSum;
        ...
        randSum[0] = halved + 1e-8;//MathUtil.logSumExp(halved, haveldP);
        randSum[1] = halved - 1e-8; //MathUtil.logSumExp(halved, -haveldP);
...
//        //System.err.println("\t+"+sum);
    ...
    private String[] splitSymbol(String lhs) throws Exception {
        ...
        if (// the first condition is redundant, still have to make up my mind on how to generalize this class
                ...
                && SymbolFractory.isLhsForSemanticRole(lhs, this.tgtRole)) {
...
//         LogManager.getLogManager().
        Logger.getLogger(SplitRoles.class.getName()).setLevel(Level.FINER);
        ...
        SplitRoles spm = new SplitRoles(2, rm);
