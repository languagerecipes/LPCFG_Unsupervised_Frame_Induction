 ...
 */
public class CYKAllParsesForPruning {

    private ExecutorService executor;
    private Collection<CYKParsingCallableAllParsePruning> task;

    public CYKAllParsesForPruning(Collection<Fragment> fragmentsAll, 
            RuleMaps theRuleMap, int threadSize, double portionNBest) throws InterruptedException {
...
//            task.add(new CYKParsingCallableAllParsePruning(subList, theRuleMap, portionNBest));
//        }
...
//        task.add(new CYKParsingCallableAllParsePruning(subList, theRuleMap, portionNBest));
        ...
        splitCollectionBySize.parallelStream().forEach(fcol -> {
            task.add(new CYKParsingCallableAllParsePruning(fcol, theRuleMap,portionNBest));
