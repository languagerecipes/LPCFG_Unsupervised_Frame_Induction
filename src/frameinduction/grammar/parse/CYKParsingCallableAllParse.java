 ...
 */
public class CYKParsingCallableAllParse implements Callable<Collection<ParseChart>> {

    final private Collection<Fragment> fcp;
    final private RuleMaps theRuleMap;
    //int id;

    public CYKParsingCallableAllParse(Collection<Fragment> fcp, RuleMaps theRuleMap) {
        this.fcp = fcp;
    ...
    public Collection<ParseChart> call() {
        ...
        for (Fragment fc : fcp) {
            ...
            try {
                ...
                Logger.getLogger(CYKParsingCallableAllParse.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
