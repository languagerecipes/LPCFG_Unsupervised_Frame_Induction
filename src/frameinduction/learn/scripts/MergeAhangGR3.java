...
public class MergeAhangGR3 {
    ...
    int maxBAtchSizeAfterFirstIteration =13;// 10;//10; a smaller value will cause a longer processing time, but it is more accurate 
    ...
    public MergeAhangGR3(
            Map<String,Integer> stxFeatrureIntValue,
        ...
        GenerteGrammarFromClusters genGrmFromClusters = new GenerteGrammarFromClusters(
        //        settins.getActiveDepToIntMap()
        stxFeatrureIntValue
        );
