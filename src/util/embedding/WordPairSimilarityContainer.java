 ...
 */
public class WordPairSimilarityContainer {
    ...
    public WordPairSimilarityContainer(RuleMaps rm, WordPairSimilaritySmallMemoryFixedID wsfIXED) throws Exception {
...
//    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        WordPairSimilarityContainer wsp = new WordPairSimilarityContainer(theRuleMap, wsm);
